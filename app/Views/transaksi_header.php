        ...
        <div class="modal-content">
            ...
            <form action="/transaksi_header/updateData/<?= $value['id_transaksi_header'] ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nomor_transaksi">Nomor Transaksi</label>
                        <input type="text" name="nomer_transaksi" id="nomer_transaksi" class="form-control" placeholder="Masukkan nomor_transaksi" value="<?= $value['nomer_transaksi'] ?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="tanggal_transaksi">Tanggal Transaksi</label>
